"""
INLAY v2 semantic-key CounterFact eval with an HONEST gate-selection protocol:
...
out = {"method":"INLAY-semkey(prompt)","model":MODEL,"n_tune":len(tune),"n_test":len(test),
